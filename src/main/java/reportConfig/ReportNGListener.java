...
public class ReportNGListener extends BaseTest implements ITestListener {
	...
	// Case 1: Capture by Image FILE - file hình ảnh phải tạo folder để lưu vào
//	@Override
...
//
//		String screenshotPath = captureScreenshotImage(webDriver, result.getName());
...
//	}
	...
	// Case 2: Capture Base64 : file hình ảnh ko cần lưu vào folder mà được nén thành dạng base 64
		@Override
		public void onTestFailure(ITestResult result) {
			try {
				System.setProperty("org.uncommons.reportng.escape-output", "false");
	...
	// Capture by Image File
	public String captureScreenshotImage(WebDriver driver, String screenshotName) {
		try {
			Calendar calendar = Calendar.getInstance();
			SimpleDateFormat formater = new SimpleDateFormat("dd_MM_yyyy_hh_mm_ss");
			File source = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
			String screenPath = GlobalConstants.REPORTING_SCREENSHORT + screenshotName + "_" + formater.format(calendar.getTime()) + ".png";
