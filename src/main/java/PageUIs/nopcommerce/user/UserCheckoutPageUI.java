...
public class UserCheckoutPageUI {
	...
	public static final String CREDIT_CARD_DROPDOWN_LIST = "xpath=//select[@id='CreditCardType']";
	public static final String CARD_HOLDER_NAME_TEXTBOX = "css=input#CardholderName";
	public static final String CARD_NUMBER_TEXTBOX = "css=input#CardNumber";
	public static final String CARD_CODE_TEXTBOX = "css=input#CardCode";
	public static final String CREDIT_CARD_CHECKBOX = "css=div.payment-details input#paymentmethod_1";
	...
	public static final String EXPIRATION_DATE_BY_ID = "xpath=//select[@id='%s']";
